...
namespace InterpolationCurve.Editor.UIElements
{
    ...
    {
        const string LAYOUT_PATH = "Assets/InterpolationCurve/Editor/UIElements/InterpolationCurveWindow.uxml";
        const string STYLESHEET_PATH = "Assets/InterpolationCurve/Editor/UIElements/InterpolationCurveWindow.uss";
        ...
        void AddToolbar()
        {
            ...
            loopTypeField = new EnumField("Clamp Type");
            loopTypeField.Q<Label>().style.width = 90;
            loopTypeField.Q<Label>().style.minWidth = 90;
            loopTypeField.Q<Label>().style.unityTextAlign = TextAnchor.MiddleRight;
            loopTypeField.Q<Label>().style.marginRight = 5;
            loopTypeField.style.width = 180;
            loopTypeField.style.height = 22;
            loopTypeField.style.marginTop = 2;

            if (interpolationCurveObject is null)
                loopTypeField.SetEnabled(false);
            else
                loopTypeField.BindProperty(interpolationCurveObject.FindProperty("clampType"));

            toolbar.Add(loopTypeField);
